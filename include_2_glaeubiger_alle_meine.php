...
<?php
    ...
    echo "<h2>Meine Gl&auml;ubiger</h2>";
	echo "<br>";
	echo "<h4>Diese Mitglieder sind derzeit im Besitz von Gutscheinen die ich benötige, um mein(e) Kont(o/en) auszugleichen</a>.</h4>";
