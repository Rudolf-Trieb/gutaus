...
<?php
    ...
    echo "<h2>Gl&auml;ubiger der <a class='gutschein' href='".$_SESSION['Einheit']."'>".$_SESSION['Einheit']."-Gutscheine</a></h2>";
	echo "<br>";
	echo "<h4>Diese Mitglieder sind derzeit im Besitz von  <a class='gutschein' href='".$_SESSION['Einheit']."'>".$_SESSION['Einheit']."-Gutscheine</a>.</h4>";
	if ($_POST['Einheit']<>'') {
		echo "<h4>Ich stehe mit ".$_POST['Schulden']." <a class='gutschein' href='".$_SESSION['Einheit']."'>".$_SESSION['Einheit']."-Gutscheine</a> in Schuld diser Mitglieder.";
		echo "<h4>Ich bin verpflichtet mindesten ".$_POST['Schulden']." <a class='gutschein'href='".$_SESSION['Einheit']."'>".$_SESSION['Einheit']."-Gutscheine</a> zu akzeptieren und dafür meine Waren oder Diestleistungen zu erbringen!!!</h4>";
	}	
