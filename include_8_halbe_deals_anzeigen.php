...
<?php
    ...
    echo " <tr>\n";
    echo "  <th colspan=6>\n";
    echo "Halbe Deals denen mein Deal-Partner schon zugestimmt hat\n";
    echo "  </th>\n";
    echo " </tr>\n";
    ...
    echo "  <th rowspan=1>\n";
    echo "Von meinem m&ouml;glichen<br>Partner zugestimmt seit\n";
    echo "  </th>\n";
   ...
   echo "<br><br><br>"; 
    ...
    echo " <tr>\n";
    echo "  <th colspan=6>\n";
    echo "Halbe Deals die noch auf Zustimmung meies Deal-Partners warten\n";
    echo "  </th>\n";
    echo " </tr>\n";
    ...
    echo "  <th rowspan=1>\n";
    echo "Von mir<br>zugestimmt seit\n";
    echo "  </th>\n";
	
	
	echo "  <th rowspan=1>\n";
	echo "Wieder ablehnen?\n";
	echo "  </th>\n";
   ...
   while ($row = mysql_fetch_assoc($result)) {
		...
		// Wieder Ablehnung?
        echo "  <td align='center'>\n";
		echo 		"<br><a class='ablehnen_deal' fremdeinheit='".$row['einheit']."' href='".$row['deal_ID']."'><img  style='width:28px' src='images/daumen_runter.gif'/></a>";
		echo        "<br>oder";
   ...
   while ($row = mysql_fetch_assoc($result)) {
		...
		// Wieder Ablehnung?
        echo "  <td align='center'>\n";
		echo 		"<br><a class='ablehnen_deal' fremdeinheit='".$row['einheit']."' href='".$row['deal_ID']."'>ablehnen</a>";
		echo        "<br>oder";
		echo 		"<br><a class='anbieten_deal' href='".$row['einheit']."'>Neues Angebot</a>";
        echo "  </td>\n";
