<?php
   //SESSION
	...
	if ($_SESSION["login"]) { // if login true
		...
		$_SESSION['member_mobile']=bereinige_und_schreibe_laenderkennung_0049_vor_handynummer($_REQUEST['member_mobile']);
		...
		$sql="    SELECT 
					...
					WHERE `Mobilnummer`='".mysql_real_escape_string(trim($_SESSION['member_mobile']))."'";
